...
class Templates extends Component {
  ...
  getAllTemplates() {
    fetch(
      'http://localhost:8081/flex/template-all',
      {
        method: 'GET',
        credentials: 'include'
      }
  ...
  deleteTemplate(templateId) {
    ...
    fetch(
      'http://localhost:8081/flex/template-delete',
      {
        method: 'POST',
        credentials: 'include',
        headers: {
  ...
  async saveTemplate(templateId) {
    ...
    if(this.templateIsNew(templateId)) {
      ...
      return fetch(
        'http://localhost:8081/flex/template-add',
        {
          method: 'POST',
          credentials: 'include',
          headers: {
      ...
      return fetch(
        'http://localhost:8081/flex/template-edit',
        {
          method: 'POST',
          credentials: 'include',
          headers: {
